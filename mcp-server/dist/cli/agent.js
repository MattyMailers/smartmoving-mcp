...
export function agentSafetyContract() {
    return {
        ok: true,
...
export function agentExamplesContract() {
    return { ok: true, source: "smartmoving-cli", workflows };
}
export function agentPrompt(workflowName) {
...
export function printAgentQuickstart(options, formatJson) {
...
export function registerAgentCommand(program, helpers) {
    ...
    agent
        ...
        .action((options) => helpers.printResult("Agent safety", agentSafetyContract(), options));
    agent
        .command("examples")
        .description("Print agent workflow command examples.")
        .addOption(helpers.jsonOption())
        .action((options) => helpers.printResult("Agent examples", agentExamplesContract(), options));
    agent
        .command("prompt")
    ...
    agent
        ...
        .action((options) => printAgentQuickstart(options, helpers.formatJson));
}
