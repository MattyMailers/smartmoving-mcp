...
export function registerJobTools(server, client) {
    ...
    // ---------- get_job ----------
    server.tool("get_job", "Get detailed information about a specific job within an opportunity. Premium tier endpoint. Returns job type, date, crew, truck, hours, stops, materials, and crew member assignments.", {
        opportunityId: z.string().uuid().describe("The opportunity ID"),
