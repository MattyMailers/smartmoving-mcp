...
export function registerReportTools(server: McpServer, client: SmartMovingClient): void {
  server.tool(
    "audit_followup_gaps",
    "A read-only batch audit for SmartMoving job numbers or quote numbers. Normalizes job numbers such as 90001-1 to quote 90001, resolves each opportunity, checks its follow-ups, and separates missing active assigned follow-ups from invalid input, not-found records, and API errors. Use this instead of calling opportunity and follow-up tools hundreds of times.",
    {
